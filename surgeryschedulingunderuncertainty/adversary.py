...
class Equiprobable(Adversary):
    ...
    def __init__(self, predictor:PredictiveModel, schedule:Schedule, task:Task, description = ""):
        ...
        # Flag variable for correctness. If the risk of overtime is too high, this variable turns false
        ...
        for block, info in schedule.items():
            ...
            if (len(patients) == 1) | (len(patients) == 0):
                continue
            ...
            #if (28 in patients) & (90 in patients) & (218 in patients):
            #    print(1+1)
            ...
            for patient in patients:
                ...
                expected_total_duration += instance_data[instance_data.patient_num == int(patient)].duration.iloc[
            ...
            if Z_bar >= info.get('block_time') + self._task.robustness_overtime:
                ...
                for patient in patients:
                    ...
                    other_patients = [x for x in patients if x != patient]
                    ...
                    # Then the quantile is picked
                    # From the instance_config, here is get the risk
                    H_bar = np.quantile(sample, 1 - self._task.robustness_risk)
        ...
        return flag, fragile_blocks, instance_data
