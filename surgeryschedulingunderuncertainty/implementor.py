...
class StandardImplementor(Implementor):
    ...
    def __init__(self, description="", task:Task = None):
        ...
        self._model.day = pyo.Param(self._model.B, within=pyo.NonNegativeIntegers)
...
class BudgetSetImplementor(Implementor): 
    ...
    def __init__(self, task:Task, description = "", ): 
        ...
        self._model.time_increment = pyo.Param(self._model.I, within=pyo.NonNegativeReals)
